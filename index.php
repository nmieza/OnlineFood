        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="" alt="Roslida Restaurant"></a> <span class="logo-text">Roslida Restaurant</span></h1></li>
                    </ul>
