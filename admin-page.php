        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                    <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><?php echo "Roslida Restaurant E-Menu Ordering System" ?></a> <span class="logo-text">Roslida Restaurant E-Menu Ordering System</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
                ...
                <li class="no-padding">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Complain</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">All Complain</a>
                                </li>
								<?php
